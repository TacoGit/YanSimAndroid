...
public static class ConversationGlobals
{
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_TopicDiscovered_" + topicID.ToString());
	}
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_TopicLearnedByStudent_" + topicID.ToString() + '_' + studentID.ToString());
	}
	...
	public static void DeleteAll()
	{
		...
		{
			Globals.Delete("Profile_" + GameGlobals.Profile + "_TopicLearnedByStudent_" + intAndIntPair.first.ToString() + '_' + intAndIntPair.second.ToString());
		}
