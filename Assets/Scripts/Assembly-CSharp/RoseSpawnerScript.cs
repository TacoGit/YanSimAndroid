...
public class RoseSpawnerScript : MonoBehaviour
{
	...
	private void SpawnRose()
	{
		...
		gameObject.GetComponent<Rigidbody>().AddForce(base.transform.forward * ForwardForce);
		gameObject.GetComponent<Rigidbody>().AddForce(base.transform.up * UpwardForce);
