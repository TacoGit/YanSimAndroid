...
public static class DatingGlobals
{
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_ComplimentGiven_" + complimentID.ToString());
	}
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_SuitorCheck_" + checkID.ToString());
	}
	...
	{
		return PlayerPrefs.GetInt("Profile_" + GameGlobals.Profile + "_SuitorTrait_" + traitID.ToString());
	}
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_TopicDiscussed_" + topicID.ToString());
	}
	...
	{
		return PlayerPrefs.GetInt("Profile_" + GameGlobals.Profile + "_TraitDemonstrated_" + traitID.ToString());
	}
