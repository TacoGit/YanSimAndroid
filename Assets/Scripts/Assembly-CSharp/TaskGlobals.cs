...
public static class TaskGlobals
{
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_GuitarPhoto_" + photoID.ToString());
	}
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_KittenPhoto_" + photoID.ToString());
	}
	...
	{
		return PlayerPrefs.GetInt("Profile_" + GameGlobals.Profile + "_TaskStatus_" + taskID.ToString());
	}
