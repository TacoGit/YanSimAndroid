...
public class GrowShrinkScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		Scale += Time.deltaTime * (Strength * Speed);
		if (!Shrink)
		{
		...
		if (Timer > 3.33333f)
		{
			...
			base.transform.localPosition = new Vector3(base.transform.localPosition.x, base.transform.localPosition.y - FallSpeed * FallSpeed, base.transform.localPosition.z);
		}
