...
public class DatingSaveData
{
	...
	public static DatingSaveData ReadFromGlobals()
	{
		...
		int[] array2 = DatingGlobals.KeysOfSuitorCheck();
		...
		int[] array5 = DatingGlobals.KeysOfTraitDemonstrated();
