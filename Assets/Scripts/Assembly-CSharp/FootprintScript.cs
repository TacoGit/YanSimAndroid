...
public class FootprintScript : MonoBehaviour
{
	...
	private void Start()
	{
		if (Yandere.Schoolwear == 0 || Yandere.Schoolwear == 2 || (Yandere.ClubAttire && ClubGlobals.Club == ClubType.MartialArts) || Yandere.Hungry || Yandere.LucyHelmet.activeInHierarchy)
		{
