...
public class ActiveAnimation : MonoBehaviour
{
	...
	public void Finish()
	{
		...
		{
			mAnimator.Play(mClip, 0, (mLastDirection != AnimationOrTween.Direction.Forward) ? 0f : 1f);
		}
	}
	...
	public void Reset()
	{
		...
		if (mAnimator != null)
		{
			mAnimator.Play(mClip, 0, (mLastDirection != AnimationOrTween.Direction.Reverse) ? 0f : 1f);
		}
	}
	...
	private void Update()
	{
		...
		if (mAnimator != null)
		{
			mAnimator.Update((mLastDirection != AnimationOrTween.Direction.Reverse) ? deltaTime : (0f - deltaTime));
			if (isPlaying)
			{
				return;
			}
	...
	private void Play(string clipName, AnimationOrTween.Direction playDirection)
	{
		...
		else if (mAnimator != null)
		{
			...
			mLastDirection = playDirection;
			mClip = clipName;
			mAnimator.Play(mClip, 0, (playDirection != AnimationOrTween.Direction.Forward) ? 1f : 0f);
		}
	}
