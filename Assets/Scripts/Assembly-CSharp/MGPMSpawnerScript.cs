...
public class MGPMSpawnerScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		else if (Wave == 9 && LoadBearer[1] == null && LoadBearer[2] == null)
		{
			...
			{
				GameObject gameObject2 = Object.Instantiate(Enemy[SpawnEnemies[ID]], base.transform.position, Quaternion.identity);
				gameObject2.transform.parent = base.transform.parent;
				gameObject2.transform.localScale = new Vector3(256f, 128f, 1f);
				gameObject2.transform.position = SpawnPositions[ID].position;
