...
public class MGPMEnemyScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		else
		{
			...
			if (DeathTimer < 5f)
			{
				...
				{
					GameObject gameObject3 = Object.Instantiate(Explosion, base.transform.position, Quaternion.identity);
			...
			{
				GameObject gameObject4 = Object.Instantiate(FinalBossExplosion, base.transform.position, Quaternion.identity);
	...
	private void OnCollisionEnter(Collision collision)
	{
		...
		{
			GameObject gameObject = Object.Instantiate(Impact, base.transform.position, Quaternion.identity);
			gameObject.transform.parent = base.transform.parent;
